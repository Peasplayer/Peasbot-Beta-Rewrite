...
const formatVariable = function(prefix, variable){
...
const applyText = function(canvas, text, defaultFontSize, width, font){
...
module.exports = class WelcomerCard {
    ...
    constructor() {
        ...
        this.textMemberCount = "- {count}. Mitglied!";
        this.textTitle = "Ciao!";
        this.colorTitle = "#000000";
        this.textMessage = "Ciao!";
        this.memberCount = "0";
